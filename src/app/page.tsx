  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8">
      <div className="glass-panel animate-fade-in px-6 py-12 md:px-12 md:py-20 text-center max-w-3xl w-full flex flex-col items-center">
        ...
        <div className="animate-fade-in delay-100 w-16 h-16 md:w-20 md:h-20 bg-[#25d366] rounded-2xl mb-6 md:mb-8 flex items-center justify-center shadow-[0_8px_32px_rgba(37,211,102,0.4)]">
        ...
        <p className="animate-fade-in delay-300 text-[#667781] text-lg md:text-xl mb-10 md:mb-12 leading-relaxed max-w-2xl">
